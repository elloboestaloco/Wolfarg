    ...
    <center>
            <div class="row mb-12">
                ...
                <a href="<?= URL_PATH ?>/Page/Faltante" class="btn btn-dark btn-lg" role="button" aria-pressed="true">Faltante</a>
                        ...
                        <a href="<?= URL_PATH ?>/Page/RepeticionRack" class="btn btn-dark btn-lg active" role="button" aria-pressed="true">Repeticion en
                            racks</a>
                        <a href="<?= URL_PATH ?>/Page/Ulote" class="btn btn-dark btn-lg" role="button" aria-pressed="true">Ulote</a>
</div>
                </div><!-- /.col -->
            </div><!-- /.row -->
            </center>
...
function tipos(tip) {
    ...
    function unidp(id) 
    {
        $.ajax({
            ...
            p.innerText =parseFloat(data['sum(Lineas)']* 100).toFixed(2) + '%';
    })
    };
    function cargardato(IC, lineid, dia, tipo, LB) {
        ...
        $.ajax({
            ...
            for (let x = 0; x < data.length; x++) {
                ...
                if (data[x]['Deposito'] == 'PR03') {
                    PR3.push(parseFloat(data[x][LB] * 100).toFixed(2));
                

                }
                if (data[x]['Deposito'] == 'MA01') {
                    MA1.push(parseFloat(data[x][LB] * 100).toFixed(2));

                }
                if (data[x]['Deposito'] == 'RS05') {
                    RS5.push(parseFloat(data[x][LB] * 100).toFixed(2));

                }
                if (data[x]['Deposito'] == 'PS02') {
                    PS2.push(parseFloat(data[x][LB] * 100).toFixed(2));

                }
                if (data[x]['Deposito'] == 'PS03') {
                    PS3.push(parseFloat(data[x][LB] * 100).toFixed(2));
