    ...
    <center>
            <div class="row mb-12">
                ...
                <a href="<?= URL_PATH ?>/Page/Faltante" class="btn btn-dark btn-lg" role="button" aria-pressed="true">Faltante</a>
                        ...
                        <a href="<?= URL_PATH ?>/Page/Noentregado" class="btn btn-dark btn-lg active" role="button" aria-pressed="true">No entregados</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <div class="inner">
                        ...
                        <h1  style="font-size: 32px">No entregados</h1>
                        </div>
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <div class="small-box bg-light">
                        <div class="inner">
                            <h3 id="RS05"><sup style="font-size: 20px"></sup>
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3 id="MA01"><sup style="font-size: 20px"></sup></h3>
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3 id="PS02"><sup style="font-size: 20px"></sup></h3>
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <div class="small-box bg-orange">
                        <div class="inner">
                            <h3 id="PS03"><sup style="font-size: 20px"></sup></h3>
                            <p>PS03</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-stats-bars"></i>
