            ...
            <div class="row mb-12">
                <div class="col-sm-12">
                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                        ...
                        <a href="<?= URL_PATH ?>/Page/Desarme" class="btn btn-dark btn-lg active" role="button" aria-pressed="true">Desarme</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-6">
                    ...
                    <div class="inner">
                        ...
                        <h1  style="font-size: 44px">Desarme</h1>
                        </div>
